...
export default function CustomModal({ children, open, onClose }) {
    return (
        open &&
        <div className="fixed flex justify-center items-center inset-0 z-50 outline-none focus:outline-none" id="modal-id">
            <div onClick={onClose} className="absolute bg-[#111111] opacity-80 inset-0 z-0"></div>
