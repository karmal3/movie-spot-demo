                        ...
                        <div className='space-y-4'>
                            ...
                            <div className='flex gap-2 flex-wrap'>
                                ...
                                <button className="relative w-auto px-4 py-2 group overflow-hidden font-semibold text-sm bg-black text-gray-100 flex justify-center items-center gap-2">
                                    ...
                                    <span className="relative transition duration-500 ease-out bg-clip-text group-hover:text-transparent group-hover:bg-gradient-to-l group-hover:from-red-500 group-hover:to-red-600">
                                        Add to watchlist
                                    </span>
                                </button>
                            </div>
